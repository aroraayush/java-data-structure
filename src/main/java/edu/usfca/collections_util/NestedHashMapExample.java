...
public class NestedHashMapExample {
    ...
    private TreeMap<String, Integer> wordTreeMap = new TreeMap<String, Integer>();

    private HashMap<Integer, HashSet<String>> nestedMap = new HashMap<Integer, HashSet<String>>();
    ...
    public void parseText(String text) {
        ...
        for (String word : words) {
            ...
            // length() function is used to count length of a String in Java
            // Count number of characters in the word
            int numChars = word.length();
            if (!nestedMap.containsKey(numChars)) {
                nestedMap.put(numChars, new HashSet<String>());
            }
        ...
        System.out.println("ArrayList:" +  wordList  + System.lineSeparator());
        System.out.println("TreeMap: " +   wordTreeMap  + System.lineSeparator());

        // Tailmap              will return a submap that contains keys
        //   >=  "elderberry"   and the corresponding values
        System.out.println("TreeMap, tailmap() : " +   wordTreeMap.tailMap("elderberry") + System.lineSeparator());
        System.out.println("TreeMap, headmap() : " + wordTreeMap.headMap("juice") + System.lineSeparator());
